...
void invaders_display(i8080_t* cpu, viewer_t* viewer) {
...
void invaders_execute_cycles(i8080_t* cpu, size_t max_cycles) {
    uint8_t opcode;
    uint8_t port;
